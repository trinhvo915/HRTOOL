...
namespace Orient.Base.Net.Core.Api.Migrations
{
    ...
    [Migration("20190725013010_AddAttachmentInInterview")]
    partial class AddAttachmentInInterview
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orient.Base.Net.Core.Api.Core.Entities.Answer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Orient.Base.Net.Core.Api.Core.Entities.AttachmentInInterview", b =>
                {
                    ...
                    b.HasKey("AttachmentId", "InterviewId");

                    b.HasAlternateKey("Id");

                    b.HasIndex("InterviewId");

                    b.ToTable("AttachmentInInterview");
                });
            ...
            modelBuilder.Entity("Orient.Base.Net.Core.Api.Core.Entities.Question", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Orient.Base.Net.Core.Api.Core.Entities.StepInJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Orient.Base.Net.Core.Api.Core.Entities.TechnicalSkill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Orient.Base.Net.Core.Api.Core.Entities.TechnicalSkillInCandidate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("TechnicalSkillInCandidate");
                });
            ...
            modelBuilder.Entity("Orient.Base.Net.Core.Api.Core.Entities.Answer", b =>
                {
                    b.HasOne("Orient.Base.Net.Core.Api.Core.Entities.Question", "Question")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("Orient.Base.Net.Core.Api.Core.Entities.AttachmentInInterview", b =>
                {
                    b.HasOne("Orient.Base.Net.Core.Api.Core.Entities.Attachment", "Attachment")
                        .WithMany("AttachmentInInterviews")
            ...
            modelBuilder.Entity("Orient.Base.Net.Core.Api.Core.Entities.TechnicalSkillInCandidate", b =>
                {
                    b.HasOne("Orient.Base.Net.Core.Api.Core.Entities.Candidate", "Candidate")
                        .WithMany("TechnicalSkillInCandidates")
                        .HasForeignKey("CandidateId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Orient.Base.Net.Core.Api.Core.Entities.TechnicalSkill", "TechnicalSkill")
                        .WithMany("TechnicalSkillInCandidates")
